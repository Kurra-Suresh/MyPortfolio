function About() {
       return (
              <section className="page">
                     <h2>About Me</h2>
                     <p>
                            I am a Frontend Developer with 4 years of professional experience, currently working at LTIMindtree since June 2022. I have been involved in building and maintaining scalable, high-performance web applications using React.js and modern JavaScript in a production environment.
                     </p>
                     <p>
